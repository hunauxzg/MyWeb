  ...
  z.ma = bdmapcfg.home; /*guoguo 改成离线的路径 */
	...
	Xc.getTilesUrl = function(a, b) {
		var c = a.x,
			d = a.y;
		var c=a.x,d=a.y;
//		my_log(bdmapcfg.tiles_hybrid.length > 0 ? bdmapcfg.tiles_hybrid : bdmapcfg.home + "tiles_hybrid");
		var tdir = bdmapcfg.tiles_hybrid.length > 0 ? bdmapcfg.tiles_hybrid : bdmapcfg.home + "tiles_hybrid";/*guoguo 使用本地卫星的瓦片 */
		tdir = tdir + "/" + b + "/" + c + "/" + d + bdmapcfg.imgext; /*guoguo 使用本地卫星的瓦片 */
//		my_log('卫星底图:'+tdir);
		return tdir;
